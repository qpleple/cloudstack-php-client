...
class CloudStackClient extends BaseCloudStackClient
{
    ...
    public function listCapabilities($page = "1")
    {
    ...
    public function listHypervisors($zoneId = "", $page = "1")
    {
    ...
    public function listZones($available = "", $domainId = "", $id = "", $page = "1")
    {
    ...
    public function listNetworkOfferings($availability = "", $displayText = "", $guestIpType = "", $id = "", $isDefault = "", $isShared = "", $name = "", $specifyVlan = "", $trafficType = "", $page = "1")
    {
    ...
    public function listResourceLimits($account = "", $domainId = "", $id = "", $resourceType = "", $page = "1")
    {
