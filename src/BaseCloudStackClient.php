...
abstract class BaseCloudStackClient {
    ...
    * @param string $hostId destination Host ID to deploy the VM to - parameter available for root admin only
    ...
    * @param string $securityGroupIds comma separated list of security groups id that going to be applied to the virtual machine. Should be passed only when vm is created from a zone with Basic Network support. Mutually exclusive with securitygroupnames parameter
    * @param string $securityGroupNames comma separated list of security groups names that going to be applied to the virtual machine. Should be passed only when vm is created from a zone with Basic Network support. Mutually exclusive with securitygroupids parameter
    ...
    * @param string $id the ID of the virtual machine
    * @param string $isRecursive Must be used with domainId parameter. Defaults to false, but if true, lists all vms from the parent specified by the domain id till leaves.
    ...
    * @param string $ the storage ID where vm&#039;s volumes belong to
    * @param string $zoneId the availability zone ID
    * @param string $ Pagination
    */
    
    public function listVirtualMachines($account = "", $domainId = "", $forVirtualNetwork = "", $groupId = "", $hostId = "", $hypervisor = "", $id = "", $isRecursive = "", $ = "", $name = "", $networkId = "", $page = "", $ = "", $podId = "", $state = "", $ = "", $zoneId = "", $ = "") {
    ...
    * @param string $ the MD5 checksum value of this template
    ...
    */
    ...
    public function listTemplates($templateFilter, $account = "", $domainId = "", $hypervisor = "", $id = "", $ = "", $name = "", $page = "", $ = "", $zoneId = "", $ = "") {
    ...
    */
    ...
    public function listTemplatePermissions($id, $account = "", $domainId = "", $ = "") {
    ...
    */
    ...
    public function listIsos($account = "", $bootable = "", $domainId = "", $hypervisor = "", $id = "", $isoFilter = "", $isPublic = "", $isReady = "", $ = "", $name = "", $page = "", $ = "", $zoneId = "", $ = "") {
    ...
    */
    ...
    public function listIsoPermissions($id, $account = "", $domainId = "", $ = "") {
    ...
    */
    ...
    public function listVolumes($account = "", $domainId = "", $hostId = "", $id = "", $isRecursive = "", $ = "", $name = "", $page = "", $ = "", $podId = "", $type = "", $virtualMachineId = "", $zoneId = "", $ = "") {
    ...
    * @param string $securityGroupId The ID of the security group. Mutually exclusive with securityGroupName parameter
    * @param string $securityGroupName The name of the security group. Mutually exclusive with securityGroupName parameter
    ...
    */
    ...
    public function listSecurityGroups($account = "", $domainId = "", $id = "", $ = "", $page = "", $ = "", $securityGroupName = "", $virtualMachineId = "", $ = "") {
    ...
    */
    ...
    public function listAccounts($accountType = "", $domainId = "", $id = "", $isCleanUpRequired = "", $isRecursive = "", $ = "", $name = "", $page = "", $ = "", $state = "", $ = "") {
    ...
    */
    ...
    public function listSnapshots($account = "", $domainId = "", $id = "", $intervalType = "", $isRecursive = "", $ = "", $name = "", $page = "", $ = "", $snapshotType = "", $volumeId = "", $ = "") {
    ...
    */
    ...
    public function listSnapshotPolicies($volumeId, $account = "", $domainId = "", $ = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listAsyncJobs($account = "", $domainId = "", $ = "", $page = "", $ = "", $startDate = "", $ = "") {
    ...
    */
    ...
    public function listEvents($account = "", $domainId = "", $duration = "", $endDate = "", $entryTime = "", $id = "", $ = "", $level = "", $page = "", $ = "", $startDate = "", $type = "", $ = "") {
    ...
    */
    ...
    public function listOsTypes($id = "", $ = "", $osCategoryId = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listOsCategories($id = "", $ = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listServiceOfferings($domainId = "", $id = "", $ = "", $name = "", $page = "", $ = "", $virtualMachineId = "", $ = "") {
    ...
    */
    ...
    public function listDiskOfferings($domainId = "", $id = "", $ = "", $name = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listRemoteAccessVpns($publicIpId, $account = "", $domainId = "", $ = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listVpnUsers($account = "", $domainId = "", $id = "", $ = "", $page = "", $ = "", $userName = "", $ = "") {
    ...
    */
    ...
    public function listPublicIpAddresses($account = "", $allocatedOnly = "", $domainId = "", $forVirtualNetwork = "", $id = "", $ipAddress = "", $ = "", $page = "", $ = "", $vlanId = "", $zoneId = "", $ = "") {
    ...
    */
    ...
    public function listPortForwardingRules($account = "", $domainId = "", $id = "", $ipAddressId = "", $ = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listIpForwardingRules($account = "", $domainId = "", $id = "", $ipAddressId = "", $ = "", $page = "", $ = "", $virtualMachineId = "", $ = "") {
    ...
    */
    ...
    public function listLoadBalancerRules($account = "", $domainId = "", $id = "", $ = "", $name = "", $page = "", $ = "", $publicIpId = "", $virtualMachineId = "", $ = "") {
    ...
    */
    ...
    public function listLoadBalancerRuleInstances($id, $applied = "", $ = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listSSHKeyPairs($ = "", $ = "", $name = "", $page = "", $ = "", $ = "") {
    ...
    */
    ...
    public function listInstanceGroups($account = "", $domainId = "", $id = "", $ = "", $name = "", $page = "", $ = "", $ = "") {
    ...
    * @param string $endIp the ending IP address in the network IP range. If not specified, will be defaulted to startIP
    ...
    * @param string $isDefault true if network is default, false otherwise
    * @param string $isShared true if network is shared across accounts in the Zone, false otherwise
    ...
    */
    ...
    public function listNetworks($account = "", $domainId = "", $id = "", $isDefault = "", $isShared = "", $isSystem = "", $ = "", $page = "", $ = "", $trafficType = "", $type = "", $zoneId = "", $ = "") {
    ...
    * Lists zones
    *
    * @param string $available true if you want to retrieve all available Zones. False if you only want to return the Zones from which you have at least one VM. Default is false.
    ...
    */
    ...
    public function listZones($available = "", $domainId = "", $id = "", $ = "", $page = "", $ = "", $ = "") {
    ...
    * @param string $guestIpType the guest ip type for the network offering, supported types are Direct and Virtual.
    ...
    */
    ...
    public function listNetworkOfferings($availability = "", $displayText = "", $guestIpType = "", $id = "", $isDefault = "", $isShared = "", $ = "", $name = "", $page = "", $ = "", $specifyVlan = "", $trafficType = "", $zoneId = "", $ = "") {
    ...
    *
    * @param string $account Lists resource limits by account. Must be used with the domainId parameter.
    * @param string $domainId Lists resource limits by domain ID. If used with the account parameter, lists resource limits for a specified account in a specified domain.
    * @param string $id Lists resource limits by ID.
    * @param string $ List by keyword
    * @param string $page 
    * @param string $ 
    * @param string $resourceType Type of resource to update. Values are 0, 1, 2, 3, and 4. 0 - Instance. Number of instances a user can create. 1 - IP. Number of public IP addresses a user can own. 2 - Volume. Number of disk volumes a user can create.3 - Snapshot. Number of snapshots a user can create.4 - Template. Number of templates that a user can register/create.
    * @param string $ Pagination
    */
    
    public function listResourceLimits($account = "", $domainId = "", $id = "", $ = "", $page = "", $ = "", $resourceType = "", $ = "") {
    ...
    * @param string $domain path of the domain that the user belongs to. Example: domain=/com/cloud/internal.  If no domain is passed in, the ROOT domain is assumed.
    */
